...
var _set0 = {
    ...
    h2: 40,
    frametop: 40,
	cls: ['#C4E538', '#7efff5', '#ffda79', '#fed330', '#7efff5', '#fffa65', '#6e7074', '#546570', '#c4ccd3', '#c4ccd3', '#bda29a']
};
...
function createOption(symbol, ltype, colorset, period, stp, edp, dates, datas, datals, vols, dataMA5, dataMA20, dataMA30)
{
    ...
    return {
        ...
        xAxis: [{
            ...
            data: dates,
            boundaryGap: false,
			axisLine: { lineStyle: { color: colorset.l3, opacity: 0.1, width: 0.1 } },
            axisLabel: {
        ...
        yAxis: [{
            scale: true,
            splitNumber: 2,
			axisLine: { lineStyle: { color: colorset.l3 } },
            splitLine: { show: true },
            axisTick: { show: false },
            axisLabel: {
                inside: true,
